...
const TRADE_TYPES = ['Buy', 'Sell', 'Swap'] // Added Swap here
  ...
  return (
    <div className="rounded-2xl border border-[#2b3139] bg-[#161a1e] overflow-hidden shadow-xl">
      <div className="px-6 py-4 border-b border-[#2b3139] flex items-center gap-2 bg-[#1e2329]/50">
        {icon}
        <span className="text-sm font-bold text-[#eaecef] uppercase tracking-wider">{title}</span>
      </div>
...
export default function TransactionsTab() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6 pb-20 px-4">
      ...
      {error && <div className="rounded-xl bg-[#f6465d]/10 border border-[#f6465d]/30 text-[#f6465d] px-4 py-3 text-sm font-bold">{error}</div>}
